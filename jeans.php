  ...
  <!-- end of sign -->
   ...
   <section class="product-section bg-img py-3">
      ...
      <div class="row justify-content-center pb-5">
        ...
        <div class="row">
          ...
          <div class="product glow">
            ...
            style="background-image: url(Photos/linent2.jpg);">
            <div class="icons">
            ...
            <div class="text text-center">
              ...
              <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-170</span><br>
              <span class="category font-weight-bold">Vertical-Stripped</span><br>
    ...
    <div class="col-md-3 d-flex">
      <div class="product glow">
        <div class="img d-flex align-items-center justify-content-center"
        style="background-image: url(Photos/linent1.jpg);">
        <div class="icons">
          <p class="icon-block d-flex">
            <a href="#" class="d-flex align-items-center justify-content-center">
              <i class="fas fa-shopping-cart"></i>
        ...
        <div class="text text-center">
          ...
          <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-91</span><br>
          <span class="category font-weight-bold">Dark Green Pant</span><br>
...
<div class="col-md-3 d-flex">
  <div class="product glow">
    <div class="img d-flex align-items-center justify-content-center"
    style="background-image: url(Photos/linent3.jpg);">
    <div class="icons">
      <p class="icon-block d-flex">
        <a href="#" class="d-flex align-items-center justify-content-center">
          <i class="fas fa-shopping-cart"></i>
    ...
    <div class="text text-center">
    <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-81</span><br>
      <span class="category font-weight-bold">Light Blue Pant</span><br>
...
<div class="product glow">
  <div class="img d-flex align-items-center justify-content-center"
  style="background-image: url(Photos/linent4.jpg);">
  <div class="icons">
    <p class="icon-block d-flex">
      <a href="#" class="d-flex align-items-center justify-content-center">
        <i class="fas fa-shopping-cart"></i>
  ...
  <div class="text text-center">
    <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-67</span><br>
    <span class="category font-weight-bold">Blue Long</span><br>
...
<!--  -->
        ...
        <div class="row">
          ...
          <div class="product glow">
            <div class="img d-flex align-items-center justify-content-center"
            style="background-image: url(Photos/linent5.jpg);">
            <div class="icons">
              <p class="icon-block d-flex">
                <a href="#" class="d-flex align-items-center justify-content-center">
                  <i class="fas fa-shopping-cart"></i>
            ...
            <div class="text text-center">
              ...
              <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-53</span><br>
              <span class="category font-weight-bold">Brown Pant</span><br>
              <span class="price">LKR:1,500</span>
            </div>
          </div>
        </div>
    ...
    <div class="col-md-3 d-flex">
      <div class="product glow">
        <div class="img d-flex align-items-center justify-content-center"
        style="background-image: url(Photos/linent6.jpg);">
        <div class="icons">
          <p class="icon-block d-flex">
            <a href="#" class="d-flex align-items-center justify-content-center">
              <i class="fas fa-shopping-cart"></i>
        ...
        <div class="text text-center">
          <span class="out">NEW</span><br>
          <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-54</span><br>
          <span class="category font-weight-bold">Black Pant</span><br>
          <span class="price">LKR:2,500</span>
        </div>
      </div>
    </div>
...
<div class="col-md-3 d-flex">
  <div class="product glow">
    <div class="img d-flex align-items-center justify-content-center"
    style="background-image: url(Photos/linent7.jpg);">
    <div class="icons">
      <p class="icon-block d-flex">
        <a href="#" class="d-flex align-items-center justify-content-center">
          <i class="fas fa-shopping-cart"></i>
    ...
    <div class="text text-center">
    <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-76</span><br>
      <span class="category font-weight-bold">Vertical-Stripped Long</span><br>
      <span class="price">LKR:1,700</span>
    </div>
  </div>
</div>
...
<div class="product glow">
  <div class="img d-flex align-items-center justify-content-center"
  style="background-image: url(Photos/linen4.jpg);">
  <div class="icons">
    <p class="icon-block d-flex">
      <a href="#" class="d-flex align-items-center justify-content-center">
        <i class="fas fa-shopping-cart"></i>
  ...
  <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-94</span><br>
    <span class="category font-weight-bold">Button Linen Pant</span><br>
...
<div class="col-md-3 d-flex">
  <div class="product glow">
    <div class="img d-flex align-items-center justify-content-center"
    style="background-image: url(Photos/linent8.jpg);">
    <div class="icons">
      <p class="icon-block d-flex">
        <a href="#" class="d-flex align-items-center justify-content-center">
          <i class="fas fa-shopping-cart"></i>
    ...
    <div class="text text-center">
    <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-28</span><br>
      <span class="category font-weight-bold">Grey Linen Pant</span><br>
      <span class="price">LKR:3,500</span>
    </div>
  </div>
  </div>
  ...
  <div class="col-md-3 d-flex">
    ...
    <div class="col-md-3 d-flex">
      <div class="product glow">
        <div class="img d-flex align-items-center justify-content-center"
        style="background-image: url(Photos/linent10.jpg);">
        <div class="icons">
          <p class="icon-block d-flex">
            <a href="#" class="d-flex align-items-center justify-content-center">
              <i class="fas fa-shopping-cart"></i>
        ...
        <div class="text text-center">
        <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-22</span><br>
          <span class="category font-weight-bold">White Linen Pant</span><br>
          <span class="price">LKR:3,500</span>
        </div>
      </div>
      </div>
      ...
      <div class="col-md-3 d-flex">
        <div class="product glow">
          <div class="img d-flex align-items-center justify-content-center"
          style="background-image: url(Photos/linent11.jpg);">
          <div class="icons">
            <p class="icon-block d-flex">
              <a href="#" class="d-flex align-items-center justify-content-center">
                <i class="fas fa-shopping-cart"></i>
          ...
          <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-20</span><br>
            <span class="category font-weight-bold">Vertical-Striped Rolled Hem Pant</span><br>
            <span class="price">LKR:2,500</span>
          </div>
        </div>
        </div>

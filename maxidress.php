  ...
  <!-- end of sign -->
               ...
               <ul class="navbar-nav ml-auto">
                   ...
                   <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" >
                     ...
                     <a class="dropdown-item" href="mididress.php">Midi Dresses</a>
                     <div class="dropdown-divider">
                     </div>
                     <a class="dropdown-item" href="minidress.php">Mini Dresses</a>
                     <div class="dropdown-divider">
                     </div>
                     <a class="dropdown-item" href="maxidress.php">Maxi Dresses</a>
                     <div class="dropdown-divider">
                     </div>
   ...
   <section class="product-section bg-img py-3">
      ...
      <div class="row justify-content-center pb-5">
        ...
        <div class="row">
          ...
          <div class="product glow">
            ...
            style="background-image: url(Photos/maxi1.jpg);">
            <div class="icons">
            ...
            <div class="text text-center">
              ...
              <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-35</span><br>
    ...
    <div class="col-md-3 d-flex">
      <div class="product glow">
        <div class="img d-flex align-items-center justify-content-center"
        style="background-image: url(Photos/maxi2.jpg);">
        <div class="icons">
          <p class="icon-block d-flex">
            <a href="#" class="d-flex align-items-center justify-content-center">
              <i class="fas fa-shopping-cart"></i>
        ...
        <div class="text text-center">
          <!-- <span class="out">NEW</span><br> -->
          <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-39</span><br>
...
<div class="col-md-3 d-flex">
  <div class="product glow">
    <div class="img d-flex align-items-center justify-content-center"
    style="background-image: url(Photos/maxi3.jpg);">
    <div class="icons">
      <p class="icon-block d-flex">
        <a href="#" class="d-flex align-items-center justify-content-center">
          <i class="fas fa-shopping-cart"></i>
...
<div class="col-md-3 d-flex">
  <div class="product glow">
    <div class="img d-flex align-items-center justify-content-center"
    style="background-image: url(Photos/blue1.jpg);">
    <div class="icons">
      <p class="icon-block d-flex">
        <a href="#" class="d-flex align-items-center justify-content-center">
          <i class="fas fa-shopping-cart"></i>
    ...
    <div class="text text-center">
      <!-- <span class="out">NEW</span><br> -->
      <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-150</span><br>
      <span class="category font-weight-bold">Blue Mini</span><br>

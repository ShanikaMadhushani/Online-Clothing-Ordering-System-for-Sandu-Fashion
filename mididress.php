    ...
    <div class="container">
      <div class="row justify-content-center pb-5">
        ...
        ?>
          ...
          <div class="product glow list-product-box">
            <!-- <div class="align-items-center justify-content-center"> -->
            <div class="img d-flex align-items-center justify-content-center" style="background-image: url(Admin/imageup/server/uploads/<?php echo $filenames[0];?>);">
        ...
        <a href=""><button type="submit" style="background: transparent; border: none; position: relative;" class="align-items-center" name="submit_to_cart">
        ...
        <a href="" class="d-flex align-items-center justify-content-center"><button type="submit" class="btn btn-default wishlist mt-1" name="submit_to_wishlist">       
            ...
            <div class="text text-center">
              ...
              <span class="code" style="font-size: 20px; font-weight:bold; color: #851889;"><?php echo $row['itemCode']; ?></span><br>

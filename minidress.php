...
<div class="product glow">
  <div class="img d-flex align-items-center justify-content-center"
  style="background-image: url(Photos/mini1.jpg);">
  <div class="icons">
    <p class="icon-block d-flex">
      <a href="#" class="d-flex align-items-center justify-content-center">
        <i class="fas fa-shopping-cart"></i>
  ...
  <div class="text text-center">
    <!-- <span class="out">NEW</span><br> -->
    <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-84</span><br>
...
<div class="col-md-3 d-flex">
  <div class="product glow">
    <div class="img d-flex align-items-center justify-content-center"
    style="background-image: url(Photos/mini2.jpg);">
    <div class="icons">
      <p class="icon-block d-flex">
        <a href="#" class="d-flex align-items-center justify-content-center">
          <i class="fas fa-shopping-cart"></i>
    ...
    <div class="text text-center">
      <!-- <span class="out">NEW</span><br> -->
      <span class="code" style="font-size:20px; font-weight:bold; color: #851889;">SF-74</span><br>
  ...
  <div class="col-md-3 d-flex">
    ...
    <div class="col-md-3 d-flex">
      ...
      <div class="col-md-3 d-flex">
        <div class="product glow">
          <div class="img d-flex align-items-center justify-content-center"
          style="background-image: url(Photos/mini5.jpg);">
          <div class="icons">
            <p class="icon-block d-flex">
              <a href="#" class="d-flex align-items-center justify-content-center">
                <i class="fas fa-shopping-cart"></i>

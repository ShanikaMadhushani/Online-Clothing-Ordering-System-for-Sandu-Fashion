...
<!-- delivery -->
<section class="delivery" style="background-color:#fff ;">
  <div class="container" style="width: 50%;">
    
        <h1 class="text-center mt-5">Delivery Information</h1>
        <hr class="del-line">
        <p class="terms-p">
       <center> We provide Island-Wide Delivery! </center>
        ...
        <p class="terms-p">
        <center>Sandu Fashion operates with a reliable group of Outsourced Courier Companies to make sure your order gets to you the right way.</center>
        </p>

        <p class="terms-p">
       <center><b> Delivery Days :</b></center><br>
       <center> Usually the deliveries happen during the Weekdays from Monday – Friday & a few packages containing Colombo Areas will be delivered 
during Saturday ( Half Day ). On Sundays & Mercantile Holidays, deliveries will not be happening.
      </center>
        </p>

        <p class="terms-p">
        <center><b>Dispatch Days :</b></center><br>
        <center>All orders placed during the Weekend will only be dispatched on Mondays ( as long it's not a declared Holiday ).
        </p></center>

        <p class="terms-p">

        <b><center>Delivery Info :</center></b><br>
        <center>We will share your Order Details such as ; Courier Service Name / Tracking No, to you via the Platform you have ordered
 ( Facebook / Instagram / WhatsApp) so that you can check up on it. </center>

        <p class="terms-p">



        <center><b>USUAL DELIVERY DURATIONS :</b> </center><br>
        <center>City Limits ( Col 01-15 ) : 2-3 Working Days <br>
Suburbs : 2-4 Working Days <br>
Outstation Areas : 3-5 Working Days </center>
        ...
        <center>Please note that on some occasions due to unforeseen circumstances, a short delay will occur with your order.
 We apologize in advance & assure to get your package delivered to you at the right time. If you have any other questions or concerns, 
 we are here to guide you!
        ...
        Simply Call us on our Hotline : <a href="#">+94767685774</a>  or Email to us at  <a href="#">sandufashion40@gmail.com</a>

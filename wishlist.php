...
<!-- end of sign -->
 ...
 <section class="cart">
    <div class="container cart-page">
      <h1 class="shop-cart">MY WISHLIST &nbsp;<i class="fas fa-heart" style="font-size: 35px;"></i></h1>
        <table class="mt-5">
            <tr>
                <th>Product</th>
                <th>Quantity</th>
            ...
            <?php 
                      ...
                      $query = "SELECT * FROM wishlist inner join products on wishlist.PID = products.PID WHERE CID = $cid ";
                      $result = mysqli_query($connection,$query);
            ...
            <tr>
                <td>
                    <div class="cart-info">
                        ...
                        <div>
                            ...
                            <a href=""><button type="submit" class="align-items-center" name="delete_wishlist">Remove
                            </button></a>
                        </form>
                        </div>
                    </div>
                ...
                <td><a href="#"><button type="submit" class="btn btn-default cart mt-1" name="submit_to_cart" style="color: #e949a1; font-weight: bold;">
              Add to Cart
            </button></a></td>
            </form>
            </tr>

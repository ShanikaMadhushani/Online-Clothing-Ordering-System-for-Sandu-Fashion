                     ...
                     <div class="card">
                       <div class="card-header" id="headingOne">
                          <h2 class="clearfix mb-0">
                            ...
                            aria-expanded="true" aria-controls="collapseOne" style="font-weight:bold; font-size:18px; text-decoration:none;">
                       ...
                       <div class="card-body">To place an order, follow the steps & place your order through our Website or you can 
                         also place an order through our Facebook / Instagram / WhatsApp at Sandu Fashion or simply WhatsApp us on 
                         +94767685774 
                       </div>
                       </div>
                     </div> 
                     ...
                     <div class="card">
                      <div class="card-header" id="headingTwo">
                         <h2 class="clearfix mb-0">
                           ...
                           aria-expanded="true" aria-controls="collapseTwo" style="font-weight:bold; font-size:18px; text-decoration:none;">
                           2.	What payment methods do Sandu Fashion accept?
                           <i class="fa fa-angle-down"></i>
                           </a>
                         </h2>
                      </div>
                      ...
                      data-parent="#accordionExample">
                      <div class="card-body">We got card Payments and COD available Island-wide.
                      </div>
                      </div>
                    </div> 
                     <!-- -- -->
                    <div class="card">
                      <div class="card-header" id="headingThree">
                         <h2 class="clearfix mb-0">
                           ...
                           aria-expanded="true" aria-controls="collapseThree" style="font-weight:bold; font-size:18px; text-decoration:none;">
                           3.	My fav design is sold out, what can I do? Will it re-stock?
                           <i class="fa fa-angle-down"></i>
                           </a>
                         </h2>
                      </div>
                      ...
                      data-parent="#accordionExample">
                      <div class="card-body">Re-stocking a certain style depends on the amount of demand it's got.
                      </div>
                      </div>
                    </div> 
                     <!-- -- -->
                    <div class="card">
                      <div class="card-header" id="headingFour">
                         <h2 class="clearfix mb-0">
                           ...
                           aria-expanded="true" aria-controls="collapseFour" style="font-weight:bold; font-size:18px; text-decoration:none;">
                      ...
                      data-parent="#accordionExample">
                      <div class="card-body">One Order will only go to the given specific Address, if in case you need 
                        to send a Gift to any loved ones, we will send to any address you provide without the Invoice Printed on.
                      </div>
                      </div>
                    </div>
                      <!--  -->
                      ...
                      <div class="card-header" id="headingFive">
                         <h2 class="clearfix mb-0">
                           ...
                           aria-expanded="true" aria-controls="collapseFive" style="font-weight:bold; font-size:18px; text-decoration:none;">
                           5.	How long does a delivery take, and what are the charges?
                           <i class="fa fa-angle-down"></i>
                           </a>
                         </h2>
                      </div>
                      ...
                      data-parent="#accordionExample">
                      <div class="card-body">Our Standard delivery is within 3-5 working days, but packages sent to Col 01-15 will only take 1-3 
                        working days. Standard Fee will be 250/= for any destination & 350/= for Outstation (Northern Province Areas).
                      </div>
                      </div>
                    </div>
                      <!--  -->
                      ...
                      <div class="card-header" id="headingSix">
                         <h2 class="clearfix mb-0">
                           ...
                           aria-expanded="true" aria-controls="collapseSix" style="font-weight:bold; font-size:18px; text-decoration:none;">
                           6.	What is the return notice period?
                           <i class="fa fa-angle-down"></i>
                           </a>
                         </h2>
                      </div>
                      ...
                      data-parent="#accordionExample">
                      <div class="card-body">
                      Exchanges are done within 07 working days since the Garment is purchased. A message requesting to do an Exchange
                       needs to be sent to us from the same platform you ordered. We will assist you with all the procedures.
                      </div>
                      </div>
                    </div>
                      <!--  -->
                      ...
                      <div class="card-header" id="headingSeven">
                         <h2 class="clearfix mb-0">
                           <a href="#" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSeven" 
                           aria-expanded="true" aria-controls="collapseSeven" style="font-weight:bold; font-size:18px; text-decoration:none;">
                      ...
                      data-parent="#accordionExample">
                      <div class="card-body">
                      Send us a message to the Platform you ordered from (Facebook / Instagram / WhatsApp), and we will share you all 
                      the details associated to your package. (Example: Courier Service Contact No along with your Package Tracking No)
                      ...
                      <div class="card-header" id="headingEight">
                         <h2 class="clearfix mb-0">
                           <a href="#" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEight" 
                           aria-expanded="true" aria-controls="collapseEight" style="font-weight:bold; font-size:18px; text-decoration:none;">
                           8.	Can I change or amend my order after it's placed?
                           <i class="fa fa-angle-down"></i>
                           </a>
                         </h2>
                      </div>
                      ...
                      data-parent="#accordionExample">
                      <div class="card-body">
                      You can only change as long as your package has not been dispatched from our premises. Just send a Message to 
                      the Platform you ordered within 2 hours & if in case it's still not dispatched, then yes you can get it changed.

 ...
 <!-- End Of Nav -->
  ...
  <section class="form my-4 mx-5">
    <div class="container" style="width:40%;">
        <div class="row no-gutters" style="background: #fff; border-radius: 30px; box-shadow: 12px 12px 22px grey;">
           
            <div class="col-lg-12 px-5 pt-5">
               
                <h4 style="color:#851889;">Account Settings</h4>
                <form action="" method="post">
                  
                           
                            <input type="password" placeholder="Current Password" name="password" class="form-control my-3 " style="border-color: #851889;">
                            <input type="password" placeholder="New Password" name="npassword" class="form-control my-3 " style="border-color: #851889;">
                            <input type="password" placeholder="Confirm Password" name="cpassword" class="form-control my-3 " style="border-color: #851889;">

                          
                       
                              <button type="submit" name="update" class="logbtn mt-3 mb-5">Update Profile</button>

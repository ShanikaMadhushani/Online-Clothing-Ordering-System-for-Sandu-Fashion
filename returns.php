...
<section class="terms-conditions" style="background-color: #fff;">
    <div class="container" style="width: 50%;">
        <h2 class="text-center mt-5" >Return Policy</h2>
        <hr class="ret-line"> 
        <p class="terms-p">
        One of our main priorities is to give you a hassle-free Return – Exchange Method. Please note that we only accept returns if 
        there is an issue on our company.
        </p>

        <h1 class="text-center2">If an exchange needs to be done:</h1>
        <p class="terms-p">
        Exchanges are done within 07 working days since the Garment is purchased.
        </p>

        <p class="terms-p">
        <b>Step 01: </b>Message us through the same platform (Facebook / Instagram / WhatsApp) you place your order with.
         Let us know you need to exchange your particular item.

        </p>

        <p class="terms-p">
        <b>Step 02:</b> After an analysis we will get back to you stating the procedure where you have to send us back the package
 through Register Post or a Courier Service. Post it back to us within 2-3 working days, sending us a picture
  (Through Facebook / Instagram / WhatsApp) of the Posted Receipt.

        </p>
        <p class="terms-p mb-5">
        <b>Step 03:</b> Once we have received the package, we will return your money or new product and courier charges are paid by us.
one of our Sales Representatives will inform you through a message so that you can select another or change the size & get your 
exchange delivered once back. If the newly picked item has a price difference, it will have to be paid by the customer, 
if the company owes the customer, it will not be refunded, it will simply be deducted the next time they make a purchase.
 A delivery fee will be charged again to send back the Exchange Item.
        </p>

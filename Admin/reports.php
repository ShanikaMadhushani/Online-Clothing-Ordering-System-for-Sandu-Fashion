            ...
            <div class="card">
                ...
                <div class="card-body">
                  <table class="table">
                    <tbody>
                    <tr><td>
                <a href="sales.php" style="text-decoration: none; "> <p style="font-size:19px; color:#851889; ">Sales Report</p></a>
                </td>
                </tr>

                <tr><td>
                <a href="stock.php" style="text-decoration: none;"> <p style="font-size:19px; color:#851889; ">Stock Report</p></a>
                </td>
                </tr>

                <tr><td>
                <a href="discount.php" style="text-decoration: none; "> <p style="font-size:19px; color:#851889; ">Discounted Products</p></a>
                </td>
                </tr>

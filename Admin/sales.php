        ...
        <div class="jumbotron" style="background: #f5ecfc ;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p style="font-size:19px; color:#851889; ">List of Orders</p>
                    ...
                    <table class="table">
                          ...
                          $query = "SELECT * FROM orders inner join products on orders.PID = products.PID";
                         ...
                         <?php }?>           
                          ...
                          <tr class="table-data">
                                 ...
                                 <td style="font-weight:bold;">7000</td>
                                 <!-- <td>2021.10.10</td>
                                 <td>12:40</td>
           -->
                  </tr>
